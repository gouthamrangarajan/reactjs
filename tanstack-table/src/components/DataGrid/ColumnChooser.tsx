...
}: ColumnChooserPropsType) {
  return (
    <AnimatePresence>
      {display && (
        <motion.div
          className={`${position} rounded-xl py-4 px-6 bg-white shadow font-normal
flex flex-col items-start w-64`}
        ...
        >
          <div className="relative w-full text-left">
            ...
            <button
              className="absolute -right-4 -top-2 appearance-none outline-none
                ...
                <Switch.Group>
                  <div className="flex items-center mt-2 w-full">
                    <Switch
                      ...
                      className={`${
                        column.getIsVisible() ? "bg-green-700" : "bg-green-400"
                      }
...
focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75`}
                    >
                      <span className="sr-only">
                        {column.columnDef.header?.toString()} setting
                      </span>
                      <span
                        aria-hidden="true"
                        className={`${
