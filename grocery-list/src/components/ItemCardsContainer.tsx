  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="relative py-1 px-3 flex flex-col w-[22rem] lg:w-[26rem] h-64 lg:h-96 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-track-green-50 scrollbar-thumb-green-500"
      >
        {items.map((item) => (
