...
export default function Search() {
  ...
  return (
    <fetcher.Form
      className="hidden items-center rounded-md bg-white px-3 py-1 text-gray-700 transition duration-300 
        focus-within:ring-2 focus-within:ring-white focus-within:ring-offset-2 focus-within:ring-offset-gray-700 lg:flex"
      method="GET"
    >
      <input
        type="text"
