...
const SearchResults = React.lazy(
  () => import("../../components/CloudPage/SearchResults")
);
const Nav = React.lazy(() => import("../../components/Nav"));
const CloudPageContextProvider = React.lazy(
  () => import("../../contexts/CloudPageContextProvider")
);
import dataType, {
  cloudType,
...
const NavSearch = React.lazy(
  () => import("../../components/CloudPage/NavSearch")
);
