...
export default function repo() {
  ...
  return (
    <main
      className="relative flex h-screen w-screen animate-fade-in flex-col overflow-y-auto overflow-x-hidden
     bg-slate-700 font-sans scrollbar-thin scrollbar-track-gray-300  scrollbar-thumb-gray-500"
    >
      <Nav
        menu={
          <>
